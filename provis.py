...
def create_workflow_dictionary():
    ...
    # legacy.model(ModelEntry("checkpoints","https://huggingface.co/bitshift/trunk/resolve/main/ColorfulRealm.safetensors")
    # legacy.model(ModelEntry("checkpoints","https://huggingface.co/bitshift/models/resolve/main/bigbirdv2.safetensors")
    # legacy.model(ModelEntry("checkpoints","https://huggingface.co/bitshift/models/resolve/main/mockingbirdv1.safetensors")
