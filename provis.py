import os, urllib.parse, json, subprocess, sys, shlex, pathlib
...
wan2_large=Workflow("wan2") # 2 text encoder, 1 image model, 1 text model, 1 vae
...
if __name__ == "__main__":
    #wan2.populate_dictionary()
    #wan2_large.populate_dictionary()
    #flux.populate_dictionary()
    
    default_workflow.populate_dictionary()
    animate_sdxl.populate_dictionary()
